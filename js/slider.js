  ...
  var aa = function (O) {
    ...
    if (
      ...
      var _,
        ...
        Zt =
          G.id ||
          ((tt = window.tnsId), (window.tnsId = tt ? tt + 1 : 1), "tns" + window.tnsId),
        $t = vn("disable"),
        te = !1,
        ee = O.freezable,
        ne = !(!ee || rt) && Ln(),
        ...
        (function () {
          ...
          if (H) {
            ...
            (i = pn(O.edgePadding, O.gutter, O.fixedWidth, O.speed, O.autoHeight)),
              ...
              I &&
                ((i =
                  q && !rt ? "width:" + mn(O.fixedWidth, O.gutter, O.items) + ";" : ""),
                x && (i += xn(mt)),
                Wi(Bt, "#" + Zt, i, Fi(Bt))),
    ...
    function yn(t) {
      var e = "";
      !1 !== t &&
        (e = (q ? "padding-" : "margin-") + (q ? "right" : "bottom") + ": " + t + "px;");
      return e;
    }
    function gn(t, e) {
    ...
    function Mn() {
      (q && !rt) ||
        (Yn(), rt ? ((Rt = ni()), ee && (ne = Ln()), (Gt = Ft()), an($t || ne)) : Ni()),
        I && ai(),
        Tn(),
        En();
    }
    ...
    function Nn(t) {
      if (U) {
        ...
        if (
          ...
          Tt !== h &&
            (Tt ? (Xe && _i(Xe), qe || Ve || mi()) : (Xe && Ui(Xe), qe && hi())),
    ...
    function Ln() {
      ...
      var t = ot ? (ot + lt) * K : _[K],
        e = ut ? st + 2 * ut : st + lt;
      return (
        ct && (e -= ot ? (st - ot) / 2 : (st - (_[qt + 1] - _[qt] - lt)) / 2), t <= e
      );
    }
    function Bn() {
